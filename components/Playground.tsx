...
import ChatArea, { useMaximizedState } from "@/components/playground/ChatArea";
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="mt-4">
                        ...
                        <p>
                          Nice work on that Frontside 180! Here are a few tips
                          to help you land it more consistently:
                        </p>
                        <ul className="list-disc pl-6 text-muted-foreground">
                          <li>
                            Make sure to keep your shoulders square and your
                            head up throughout the rotation
                          </li>
                          <li>
                          ...
                          <li>
                            Commit fully to the rotation and don't be afraid to
                            go for it
                          </li>
                        </ul>
